...
CREATE TABLE "AccountSecurity" (
    ...
    "loginPasswordSet" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "FaceVerification" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "FaceVerification_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
