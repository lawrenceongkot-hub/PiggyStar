...
const existing = await prisma.staffPermission.findUnique({
...
isSystem: true,
permissions: permissionIds.filter(id => {
const idx = permissionIds.indexOf(id);
...
let roleId;
if (existing) {
// Remove old permissions and update
